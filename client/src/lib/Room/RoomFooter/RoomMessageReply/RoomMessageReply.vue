<template>
    ...
    <div class="vac-reply-box">
        ...
        <img v-if="isImage" :src="FileSystemWritableFileStream.url" class="vac-image-reply" />
        ...
        v-else-if="isAudio"
        :src="firstFile.url"
        :message-selection-enable="false"
    ...
    <div v-else-if="isOtherFile" class="vac-image vac-file-container">
        <div>
            <slot name="file-icon">
                <svg-icon name="file" />
            </slot>
